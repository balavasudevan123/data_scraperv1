...
function getConnection() {
	...
	global $db_data_scraperv1_db_Url, $db_data_scraperv1_db_User, $db_data_scraperv1_db_Pass, $db_data_scraperv1_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_data_scraperv1_db_Url.";dbname=".$db_data_scraperv1_db_DbName, $db_data_scraperv1_db_User, $db_data_scraperv1_db_Pass);
